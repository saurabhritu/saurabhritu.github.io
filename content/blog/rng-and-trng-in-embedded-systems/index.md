...
tags:
  ...
  - cryptography
  - embedded
image: "images/entropy_vs_grid_theme_aware.svg"
...
![PRNG vs TRNG: The Two Paths to Randomness](images/prng_vs_trng.svg)
...
![Smart Door Lock: Why Weak RNG Breaks Everything](images/smart_lock_attack.svg)
...
![TRNG Hardware Architecture: Three-Stage Pipeline](images/trng_hardware_architecture.svg)
...
![Search Space Collapse: Timer Seed vs Hardware TRNG](images/search_space.svg)
...
![Cryptography: The Three Pillars of Security](images/crypto_pillars.svg)
...
![IoT Threat Landscape: Attacks vs Cryptographic Defenses](images/threat_landscape.svg)
...
![Smart Door Lock: Challenge-Response Authentication](images/smart_lock_auth_flow.svg)
...
![ESP32 Secure OTA: Cryptographic Pipeline](images/ota_pipeline.svg)
