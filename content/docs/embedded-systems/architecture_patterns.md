...
**Takeaway:** Good embedded architecture assumes hardware *will* fail and constraints *will* be pushed. Design your system to fail gracefully and recover automatically.